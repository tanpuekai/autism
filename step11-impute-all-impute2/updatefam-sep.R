...
fam1<-read.table(arg1[2],stringsAsFactors=F)
...
fam1[,3]<-sample1$father[ind12]
#fam1[!is.na(ind22),3]<-sample2$father[ind22[!is.na(ind22)]]

fam1[,4]<-sample1$mother[ind12]
#fam1[!is.na(ind22),4]<-sample2$mother[ind22[!is.na(ind22)]]

write.table(fam1,file=arg1[2],quote=F,row.names=F,col.names=F,sep="\t")
