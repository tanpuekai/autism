...
samplefile=$sampledir/step6-b37-$ids-chr-$chro.phased.sample
...
sourcehaps=/psychipc01/disk1/users/pkchen/autism_b37_pstrnd/step10-shapeit-phasing/out-step6-b37-$ids/step6-b37-$ids-chr-$chro.phased.haps
refhap=/psychipc01/disk1/users/pkchen/1000genome/release-20101123/conversion-to-haps-legend/chr-"$chro"-maf0.01.impute.hap.gz
refleg=/psychipc01/disk1/users/pkchen/1000genome/release-20101123/conversion-to-haps-legend/chr-"$chro"-maf0.01.impute.legend.gz
gmap=/psychipc01/disk1/users/pkchen/autism_b37_pstrnd/genetic_map_b37/genetic_map_chr"$chro"_combined_b37.txt

UUID1=`cat /proc/sys/kernel/random/uuid`

Rscript sep-chunks.R "temp/tmp-$UUID1.txt" $from $to $NUM
