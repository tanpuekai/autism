...
target="/psychipc01/disk1/users/pkchen/autism_b37_pstrnd/step5-extract-even-to-vcf/step4-b37-157sporadics-94controls-370K.vcf.gz"
...
java -Xmx2000m -jar b4.r1274.jar ref=$dirref/chr-$chro-maf0.01.vcf.gz gt=$target chrom=$fromto out=out-b4-157-94-even/chr$chro-seg$seg.ref
