...
#sampledir=/psychipc01/disk1/users/pkchen/autism_b37_pstrnd/step10-shapeit-phasing/out-step7-b37
...
do
	...
	sample=$sampledir/step7-b37-$ids-chr-$chr.phased.sample
	for seg in {1..7}
	do
		...
		$gtool -G --g  $chunktmp --s $sampledir/step7-b37-$ids-chr-$chr.phased.sample --snp --ped $outprefix.ped --map $outprefix.map --phenotype plink_pheno --threshold 0.9
